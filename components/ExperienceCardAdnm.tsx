	...
	return (
		<motion.div
			...
			<div className='px-2 md:px-8 '>
				<p className='font-bold text-xl mt-1'>Frontend Developer</p>
				...
				<p className='uppercase py-3 text-gray-800'>Nov.2021 - July.2023</p>
				<ul
					role='list'
					className='marker:text-indigo-400 list-disc pl-5 space-y-3 text-slate-800'>
					<li>
						{' '}
						Help release the new version on time. Add state management(NGXS) to
						20% components(Total: 150+)
					</li>
					<li>
						{' '}
						Troubleshoot errors maily related to asynchronous processing and
						responsive UI{' '}
					</li>
